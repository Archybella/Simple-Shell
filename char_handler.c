...
/**
* is_chain_delimiter - test if the current character in
...
/**
* check_chain_continue - checks if we should continue
...
* Return: Void
*/
void check_chain_continue(info_t *info, char *buf, size_t *p,
		size_t i, size_t len)
{
size_t j = *p;
