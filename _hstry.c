...
*/
static int _renumber_history(info_t *info)
{
...
*/
static char *_get_history_file(info_t *info)
{
char *buf, *dir;
...
/**
* _write_history - Creates a file or appends to an existing file with history.
* @info: The parameter struct.
*
